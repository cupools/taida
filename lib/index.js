...
exports.default = function (opt) {
  var options = _proof2.default.peace(opt, _lint2.default);
  ...
  _apikey2.default.alternate = alternate;
  ...
  var compressP = function compressP(img) {
    ...
    var fallback = function fallback() {
      ...
      return (0, _taida2.default)(_apikey2.default.get(), img.buffer, fallback);
    };

    return (0, _taida2.default)(key, img.buffer, fallback).then(function (ret) {
