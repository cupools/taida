...
exports.default = {
  ...
  config: function config(opt) {
    ...
    var options = (0, _checkin2.default)(opt, (0, _lodash2.default)(_lint.apikeyLint, {
    ...
    _emitter2.default.emit('apikey.config', this.__apikeys);
    return this;
  },
  get: function get() {
  ...
  depress: function depress(key) {
    ...
    if (!item) {
      ...
      item.valid = false;
      item.date = Date.now();
      _emitter2.default.emit('apikey.depress', key, this.__apikeys);
    }
