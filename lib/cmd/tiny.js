...
exports.default = {
  main: function main(options) {
    ...
    var resources = (0, _from2.default)(new _set2.default([].concat(options.pattern).map(function (f) {
    ...
    // only work for cli
    _apikey2.default.initKeys();
    _apikey2.default.addListener();
...
function _restore() {
  ...
  db.forEach(function (item) {
    ...
    _fsExtra2.default.copySync(item.backup, path);
