...
_commander2.default.command('tiny', null, {
  noHelp: true
...
_commander2.default.command('apikey').description('apikey').option('-a --add [apikeys...]').option('-d --del [apikeys...]').option('   --list').option('   --edit').option('   --clear').action(function (apikey) {
  console.log(apikey);
});
